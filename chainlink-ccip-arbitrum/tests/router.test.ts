...
describe("OffRamp", () => {
  beforeEach(() => {
    let offRampAddress1 = Address.fromString("0x46b639a3c1a4cbfd326b94a2db7415c27157282f");
    let addressArray = ethereum.Value.fromAddressArray([
      Address.fromString("0x95222290dd7278aa3ddd389cc1e1d165cc4bafe5"),
    ]);
    createMockedFunction(offRampAddress1, "getSupportedTokens", "getSupportedTokens():(address[])").returns([
      addressArray,
    ]);

    let contract = EVM2EVMOffRamp.bind(offRampAddress1);
  ...
  describe("handleNewMessage", () => {
    ...
    test("Message calldataHash is saved", () => {
      assert.fieldEquals(
        "Message",
